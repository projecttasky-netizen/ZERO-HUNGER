  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      role: 'assistant',
      content: 'Γεια σας! Είμαι ο ψηφιακός βοηθός του FoodLink CY. Πώς μπορώ να σας βοηθήσω σήμερα σχετικά με τη σπατάλη τροφίμων ή τα προγράμματά μας;',
      timestamp: new Date()
    }
  ]);
  ...
  const handleSendMessage = async (text: string) => {
    ...
    try {
      ...
      const chat = genAI.chats.create({
        model: model,
        config: {
          systemInstruction: `Είσαι ο ψηφιακός βοηθός του FoodLink CY, ενός οργανισμού στην Κύπρο που καταπολεμά τη σπατάλη τροφίμων. 
          Οι απαντήσεις σου πρέπει να είναι ευγενικές, ενημερωτικές και να ενθαρρύνουν τη συμμετοχή.
          
          Βασικές πληροφορίες για το FoodLink CY:
          ...
          {messages.length === 1 && (
            ...
            >
              ...
              <p className="text-slate-600 text-sm mb-6 leading-relaxed">
                Είμαι εδώ για να απαντήσω στις ερωτήσεις σας σχετικά με τη λειτουργία του FoodLink CY, τις δωρεές τροφίμων και την ασφάλεια των διαδικασιών μας.
              </p>
